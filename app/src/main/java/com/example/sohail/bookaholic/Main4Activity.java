...
public class Main4Activity extends AppCompatActivity {
    ...
    private EditText mEditTextFileName,price;
        ...
        mButtonUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mUploadTask != null && mUploadTask.isInProgress()) {
                    Toast.makeText(Main4Activity.this, "Upload in progress", Toast.LENGTH_SHORT).show();
                } else {
                    uploadFile();
                }
            }
...
//                            }, 500);
                            mStorageRef.child(s).getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    Upload upload = new Upload(mEditTextFileName.getText().toString().trim(),price.getText().toString().trim(),
                                            download);
